...
def main():
    ...
    H2 = compute_entropy(bigram_freqs)
    H2_no_repeats = compute_entropy(bigram_freqs_no_repeats)
    ...
    H2_no_underscores = compute_entropy(bigram_freqs_no_underscores)
    H2_no_repeats_no_underscores = compute_entropy(bigram_freqs_no_repeats_no_underscores)
